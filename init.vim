...
for setting_file in split(glob(stdpath('config').'/settings/*.vim')) + split(glob(stdpath('config').'/settings/*.lua'))
    execute 'source' setting_file
endfor

set guifont=FiraCode\ Nerd\ Font\ Mono:h9:cANSI
...
EOF
command! ReloadConfig source ~/.config/nvim/init.vim | echo "Ok! Updated configuration."
